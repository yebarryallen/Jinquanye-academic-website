...
![Check--Network-index?_-Cookie](baidu_index-cookie.png "Check--Network-index?_-Cookie")

#### **Attention!**  Long time to use the same cookie crawl data Baidu will prohibit users from accessing [this page](https://index.baidu.com/). This will make the program crawl to get the value of the empty value, and then report an error.


#### Solution: Login with a new account to get a new cookie.
